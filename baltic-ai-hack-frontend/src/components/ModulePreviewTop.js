...
const ModulePreviewTop = ({ title, questionCount, points, onDelete }) => {
  return (
    <div className="flex flex-col items-center">
      <div className="flex flex-wrap gap-10 justify-between items-center max-w-full w-[930px]">
        ...
        <div className="flex gap-2 items-center self-stretch my-auto min-w-[240px]">
          <button className="px-4 py-3.5 bg-white border border-solid rounded-lg text-blue-600 font-semibold shadow-sm">
            Return to editing
          </button>
          <button className="px-4 py-3.5 bg-blue-600 text-white rounded-lg font-semibold">
            Submit
          </button>
          <button
      ...
      <div className="mt-6 text-base font-medium text-gray-500">
        This is just some filler description of the study module...
      </div>
    </div>
  );
};
